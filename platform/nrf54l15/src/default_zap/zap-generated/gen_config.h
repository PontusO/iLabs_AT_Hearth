...
// Use this macro to check if the server side of the Microwave Oven Control
// cluster is included
...
// Use this macro to check if the server side of the Water Heater Management
// cluster is included
...
// Use this macro to check if the server side of the Water Heater Mode cluster
// is included
...
// Use this macro to check if the server side of the Meter Identification
// cluster is included
...
#define REFRIGERATOR_AND_TEMPERATURE_CONTROLLED_CABINET_MODE_ENABLE_CHANGE_TO_MODE_CMD \
  1
