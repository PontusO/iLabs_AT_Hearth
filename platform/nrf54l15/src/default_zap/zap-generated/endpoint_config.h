...
#define GENERATED_ATTRIBUTE_COUNT 477
#define GENERATED_ATTRIBUTES                                                   \
  {                                                                            \
      ...
      {ZAP_SIMPLE_DEFAULT(2), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                 \
       ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                    \
                                                                               \
      /* Endpoint: 240, Cluster: Refrigerator And Temperature Controlled       \
         Cabinet Mode (server) */                                              \
      {ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* SupportedModes */                 \
      ...
      {ZAP_EMPTY_DEFAULT(), 0x00000000, 4, ZAP_TYPE(BITMAP32),                 \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* Mask */                           \
      {ZAP_EMPTY_DEFAULT(), 0x00000002, 4, ZAP_TYPE(BITMAP32),                 \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* State */                          \
      {ZAP_EMPTY_DEFAULT(), 0x00000003, 4, ZAP_TYPE(BITMAP32),                 \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* Supported */                      \
      {ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),               \
       ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                         \
      {ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                 \
       ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                    \
      ...
      {ZAP_EMPTY_DEFAULT(), 0x00000000, 4, ZAP_TYPE(ELAPSED_S),                \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* CookTime */                       \
      {ZAP_EMPTY_DEFAULT(), 0x00000001, 4, ZAP_TYPE(ELAPSED_S),                \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* MaxCookTime */                    \
      {ZAP_EMPTY_DEFAULT(), 0x00000002, 1, ZAP_TYPE(INT8U),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* PowerSetting */                   \
      {ZAP_EMPTY_DEFAULT(), 0x00000003, 1, ZAP_TYPE(INT8U),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* MinPower */                       \
      {ZAP_EMPTY_DEFAULT(), 0x00000004, 1, ZAP_TYPE(INT8U),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* MaxPower */                       \
      {ZAP_EMPTY_DEFAULT(), 0x00000005, 1, ZAP_TYPE(INT8U),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* PowerStep */                      \
      {ZAP_EMPTY_DEFAULT(), 0x00000006, 0, ZAP_TYPE(ARRAY),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* SupportedWatts */                 \
      {ZAP_EMPTY_DEFAULT(), 0x00000007, 1, ZAP_TYPE(INT8U),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* SelectedWattIndex */              \
      {ZAP_EMPTY_DEFAULT(), 0x00000008, 2, ZAP_TYPE(INT16U),                   \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* WattRating */                     \
      {ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                 \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                     \
      {ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                 \
      ...
      {ZAP_EMPTY_DEFAULT(), 0x00000000, 1, ZAP_TYPE(BITMAP8),                  \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* HeaterTypes */                    \
      {ZAP_EMPTY_DEFAULT(), 0x00000001, 1, ZAP_TYPE(BITMAP8),                  \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* HeatDemand */                     \
      {ZAP_EMPTY_DEFAULT(), 0x00000002, 2, ZAP_TYPE(INT16U),                   \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* TankVolume */                     \
      {ZAP_EMPTY_DEFAULT(), 0x00000003, 8, ZAP_TYPE(ENERGY_MWH),               \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* EstimatedHeatRequired */          \
      {ZAP_EMPTY_DEFAULT(), 0x00000004, 1, ZAP_TYPE(PERCENT),                  \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* TankPercentage */                 \
      {ZAP_EMPTY_DEFAULT(), 0x00000005, 1, ZAP_TYPE(ENUM8),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* BoostState */                     \
      {ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                 \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                     \
      {ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                   \
      ...
      {ZAP_EMPTY_DEFAULT(), 0x00000001, 1, ZAP_TYPE(ENUM8),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* SupplyState */                    \
      {ZAP_EMPTY_DEFAULT(), 0x00000002, 1, ZAP_TYPE(ENUM8),                    \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* FaultState */                     \
      {ZAP_EMPTY_DEFAULT(), 0x00000003, 4, ZAP_TYPE(EPOCH_S),                  \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) |   \
           ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* ChargingEnabledUntil */           \
      {ZAP_EMPTY_DEFAULT(), 0x00000005, 8, ZAP_TYPE(AMPERAGE_MA),              \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* CircuitCapacity */                \
      {ZAP_EMPTY_DEFAULT(), 0x00000006, 8, ZAP_TYPE(AMPERAGE_MA),              \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* MinimumChargeCurrent */           \
      {ZAP_EMPTY_DEFAULT(), 0x00000007, 8, ZAP_TYPE(AMPERAGE_MA),              \
       ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
           ZAP_ATTRIBUTE_MASK(READABLE)}, /* MaximumChargeCurrent */           \
...
#define ZAP_FIXED_ENDPOINT_DATA_VERSION_COUNT 60

// This is an array of EmberAfEndpointType structures.
#define GENERATED_ENDPOINT_TYPES                                               \
  {                                                                            \
      {ZAP_CLUSTER_INDEX(0), 15, 23},                                          \
      {ZAP_CLUSTER_INDEX(15), 46, 443},                                        \
  }
